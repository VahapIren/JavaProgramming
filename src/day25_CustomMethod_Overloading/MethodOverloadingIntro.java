...
public class MethodOverloadingIntro {
    public static void main(String[] args) {
        int[] intArray={1,2,3,45,0,-2};
        Arrays.sort(intArray);
        double[] doubleArray={10.5,11.5,12.5,5.5};
        Arrays.sort(doubleArray);
        char[] charArray={'E','F','B','D','C','A'};
        Arrays.sort(charArray);
        System.out.println("-------------------------------");

        int sum1=sumOfNumbers(10,20,60);
        int sum2=sumOfNumbers(10,20,30);
        int sum3=sumOfNumbers(10,20,30,40);

        double sum4=sumOfNumbers(4.5,5.5);
        double sum5=sumOfNumbers(4.5,5.5,6.5);
        double sum6=sumOfNumbers(4.5,5.5,6.6,7.5);
